...
MV_E_PRECONDITION = 0x80000008  # < \~chinese 前置条件有误，或运行环境已发生变化       \~english Precondition error, or running
# environment changed
...
MV_E_ABNORMAL_IMAGE = 0x8000000B  # < \~chinese 异常图像，可能是丢包导致图像不完整       \~english Abnormal image, maybe incomplete
# image because of lost packet
